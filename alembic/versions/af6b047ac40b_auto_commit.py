...
Revision ID: af6b047ac40b
Revises: 
Create Date: 2021-06-08 09:27:06.417051
...
def upgrade():
    ...
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='create time of the record'),
    sa.Column('updated_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True, comment='update time of the record'),
